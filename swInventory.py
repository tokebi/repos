...
class SwInventory():
	...
	def __getJName(self):
		...
		elif self.masterType ==  9 and self.masterId ==  3:		return "光と闇の召還書"
		elif self.masterType ==  9 and self.masterId ==  4:		return "水の召還書"
		elif self.masterType ==  9 and self.masterId ==  5:		return "火の召還書"
		elif self.masterType ==  9 and self.masterId ==  6:		return "風の召還書"
		elif self.masterType ==  9 and self.masterId ==  7:		return "伝説の召還書"
